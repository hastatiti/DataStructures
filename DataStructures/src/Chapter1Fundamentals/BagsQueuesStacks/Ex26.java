...
public class Ex26<Item> implements Iterable<Item> {
	 private Node first; // top of stack (most recently added node)
	   ...
	   public void remove(Ex26<String> list,String key) {
		   int counter =0;
		   for(String s : list) {
			   counter++;
			   if(s == key) {
	...
	public static void main(String[] args) {
		...
		System.out.println("After 'b' and 'c' removed ------------->");
		list.remove(list, "b");
		list.remove(list, "c");
		for (String s : list) {
			System.out.println(s);
